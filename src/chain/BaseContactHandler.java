//Jose Araya
// This is the Abstract Handler in the Chain of Responsibility Pattern.
...
public abstract class BaseContactHandler implements ContactHandler {
    ...
    // Sets the next handler and returns it for chaining
    public ContactHandler setNext(ContactHandler n) {
