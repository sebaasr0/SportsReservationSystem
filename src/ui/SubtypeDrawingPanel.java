...
public class SubtypeDrawingPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Hover effect
        if (hovered && !selected) {
            g2d.setColor(new Color(55, 55, 60));  // Lighter gray on hover
            g2d.fillRect(0, 0, w, h);
        }

        // Selection border - Vibrant Orange
        if (selected) {
            g2d.setColor(new Color(249, 115, 22));  // Vibrant Orange
        ...
        // Price - Cyan
        g2d.setColor(new Color(34, 211, 238));  // Cyan
    ...
    private void drawTennisCourt(Graphics2D g2d, int x, int y, int w, int h, boolean isSingles) {
        ...
        // Singles lines (highlighted for singles) - Orange highlight
        if (isSingles) {
            g2d.setColor(new Color(249, 115, 22));  // Vibrant Orange
            g2d.setStroke(new BasicStroke(3));
            int margin = w/8;
    ...
    private void drawPadelCourt(Graphics2D g2d, int x, int y, int w, int h, boolean hasRoof) {
        ...
        // Walls
        g2d.setColor(new Color(55, 55, 60));  // Dark gray walls
        ...
        // Roof indicator
        if (hasRoof) {
            g2d.setColor(new Color(80, 80, 85));  // Slightly lighter for roof
            g2d.setStroke(new BasicStroke(3));
